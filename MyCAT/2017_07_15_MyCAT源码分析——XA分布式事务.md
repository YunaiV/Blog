...
摘要: 原创出处 http://www.iocoder.cn/MyCAT/xa-distributed-transaction/ 「芋道源码」欢迎转载，保留摘要，谢谢！

**本文主要基于 MyCAT 1.6.5 正式版**  

- [1. 概述](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
- [2. XA 概念](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
- [3. MyCAT 代码实现](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [3.1 JDBC Demo 代码](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [3.2 MyCAT 开启 XA 事务](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [3.3 MyCAT 接收 SQL](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [3.4 MySQL 接收 COMMIT](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
		- [3.4.1 单节点事务 or 多节点事务](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
		- [3.4.2 协调日志](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
		- [3.4.3 MultiNodeCoordinator](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [3.5 MyCAT 启动回滚 XA事务](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
- [4. MyCAT 实现缺陷](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [4.1 协调日志写入性能](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [4.2 数据节点未全部 PREPARE 就进行 COMMIT](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [4.3 MyCAT 启动回滚 PREPARE 的 XA事务](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [4.4 单节点事务未记录协调日志](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
	- [4.5 XA COMMIT 部分节点挂了重新恢复后，未进一步处理](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
- [5. 彩蛋](http://www.iocoder.cn/MyCAT/xa-distributed-transaction/)
