...
- [1、概述](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [2、Consumer](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [3、PushConsumer 一览](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [4、PushConsumer 订阅](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [DefaultMQPushConsumerImpl#subscribe(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [FilterAPI.buildSubscriptionData(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [DefaultMQPushConsumer#registerMessageListener(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [5、PushConsumer 消息队列分配](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [RebalanceService](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [MQClientInstance#doRebalance(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [DefaultMQPushConsumerImpl#doRebalance(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [RebalanceImpl#doRebalance(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [RebalanceImpl#rebalanceByTopic(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [RebalanceImpl#removeUnnecessaryMessageQueue(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [RebalancePushImpl#removeUnnecessaryMessageQueue(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [[PullConsumer] RebalancePullImpl#removeUnnecessaryMessageQueue(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [RebalancePushImpl#dispatchPullRequest(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [DefaultMQPushConsumerImpl#executePullRequestImmediately(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [AllocateMessageQueueStrategy](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [AllocateMessageQueueAveragely](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [AllocateMessageQueueByMachineRoom](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [AllocateMessageQueueAveragelyByCircle](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [AllocateMessageQueueByConfig](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [5、PushConsumer 消费进度读取](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [RebalancePushImpl#computePullFromWhere(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [[PullConsumer] RebalancePullImpl#computePullFromWhere(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [6、PushConsumer 拉取消息](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [PullMessageService](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [DefaultMQPushConsumerImpl#pullMessage(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [PullAPIWrapper#pullKernelImpl(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [PullAPIWrapper#recalculatePullFromWhichNode(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [MQClientInstance#findBrokerAddressInSubscribe(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [PullAPIWrapper#processPullResult(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [ProcessQueue#putMessage(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [总结](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [6、PushConsumer 消费消息](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [ConsumeMessageConcurrentlyService 提交消费请求](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [ConsumeMessageConcurrentlyService#submitConsumeRequest(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [ConsumeMessageConcurrentlyService#submitConsumeRequestLater](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [ConsumeRequest](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [ConsumeMessageConcurrentlyService#processConsumeResult(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [ProcessQueue#removeMessage(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [ConsumeMessageConcurrentlyService#cleanExpireMsg(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [ProcessQueue#cleanExpiredMsg(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [7、PushConsumer 发回消费失败消息](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [DefaultMQPushConsumerImpl#sendMessageBack(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [MQClientAPIImpl#consumerSendMessageBack(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [8、Consumer 消费进度](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
	- [OffsetStore](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [OffsetStore#load(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [LocalFileOffsetStore#load(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
				- [OffsetSerializeWrapper](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [RemoteBrokerOffsetStore#load(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [OffsetStore#readOffset(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [LocalFileOffsetStore#readOffset(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [RemoteBrokerOffsetStore#readOffset(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [OffsetStore#updateOffset(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
		- [OffsetStore#persistAll(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [LocalFileOffsetStore#persistAll(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [RemoteBrokerOffsetStore#persistAll(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
			- [MQClientInstance#persistAllConsumerOffset(...)](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
- [9、结尾](http://www.iocoder.cn/RocketMQ/message-pull-and-consume-second/)
